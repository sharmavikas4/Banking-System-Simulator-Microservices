...
public class WithdrawServiceTest {
	...
	private NotificationRequest createNotificationRequest(Transaction transaction) {
	    String msg = String.format(
	        "TXID=%s | ACCOUNT=%s | AMOUNT=%.2f | TYPE=WITHDRAW | STATUS=%s",
	...
	void withdraw_Success() {
		...
		TransactionRequest transactionRequest = createTransactionRequest(accountNumber, amount);
		Transaction transaction = createTransaction(accountNumber, txnId, amount, TransactionStatus.SUCCESS);
		...
		NotificationRequest notificationRequest = createNotificationRequest(transaction);
	...
	@Test
	void withdraw_AccountServiceClient_AccountNotFound() {
		String accountNumber="VIK3710";
		double amount =1000;
		String txnId = GenerateTransactionId.generate();
		TransactionRequest transactionRequest = createTransactionRequest(accountNumber, amount);
		Transaction transaction = createTransaction(accountNumber, txnId, amount, TransactionStatus.FAILED);
		...
		String message = "Notification Logged Successfully";
		when(notificationServiceClient.sendNotification(notificationRequest)).thenReturn(message);
		assertThrows(AccountNotFoundException.class, () -> transactionService.withdraw(transactionRequest));
	    verify(accountServiceClient, times(1)).updateBalance(eq(accountNumber), any(AccountTransactionRequest.class));
	    verify(notificationServiceClient, times(1)).sendNotification(any());
		verify(transactionRepository,times(1)).save(any(Transaction.class));
	}
	@Test
	void withdraw_AccountServiceClient_AccountNotFound_DatabaseException() {
		String accountNumber="VIK3710";
		double amount =1000;
		TransactionRequest transactionRequest = createTransactionRequest(accountNumber, amount);
		when(accountServiceClient.updateBalance(eq(accountNumber), any(AccountTransactionRequest.class))).thenThrow(new AccountNotFoundException("No Account Found"));
		when(transactionRepository.save(any(Transaction.class))).thenThrow(new DatabaseException("Database Error"));
		assertThrows(DatabaseException.class, () -> transactionService.withdraw(transactionRequest));
	    verify(accountServiceClient, times(1)).updateBalance(eq(accountNumber), any(AccountTransactionRequest.class));
		verify(transactionRepository,times(1)).save(any(Transaction.class));
	}
	@Test
	void withdraw_AccountServiceClient_AccountNotFound_NotificationNotSent() {
		String accountNumber="VIK3710";
		double amount =1000;
		String txnId = GenerateTransactionId.generate();
		TransactionRequest transactionRequest = createTransactionRequest(accountNumber, amount);
	...
	@Test
	void withdraw_AccountServiceClient_InactiveAccountException() {
		String accountNumber="VIK3710";
		double amount =1000;
		String txnId = GenerateTransactionId.generate();
		TransactionRequest transactionRequest = createTransactionRequest(accountNumber, amount);
		...
		String message = "Notification Logged Successfully";
		when(notificationServiceClient.sendNotification(notificationRequest)).thenReturn(message);
		assertThrows(InactiveAccountException.class, () -> transactionService.withdraw(transactionRequest));
	    verify(accountServiceClient, times(1)).updateBalance(eq(accountNumber), any(AccountTransactionRequest.class));
	    verify(notificationServiceClient, times(1)).sendNotification(any());
		verify(transactionRepository,times(1)).save(any(Transaction.class));
	}
	@Test
	void withdraw_AccountServiceClient_InactiveAccountException_DatabaseException() {
		String accountNumber="VIK3710";
		double amount =1000;
		TransactionRequest transactionRequest = createTransactionRequest(accountNumber, amount);
		when(accountServiceClient.updateBalance(eq(accountNumber), any(AccountTransactionRequest.class))).thenThrow(new InactiveAccountException("Inactive Account"));
	...
	@Test
	void withdraw_AccountServiceClient_InactiveAccountException_NotificationNotSent() {
		String accountNumber="VIK3710";
		double amount =1000;
		String txnId = GenerateTransactionId.generate();
		TransactionRequest transactionRequest = createTransactionRequest(accountNumber, amount);
	...
	@Test
	void withdraw_AccountServiceClient_InsufficientBalanceException() {
		String accountNumber="VIK3710";
		double amount =1000;
		String txnId = GenerateTransactionId.generate();
		TransactionRequest transactionRequest = createTransactionRequest(accountNumber, amount);
		Transaction transaction = createTransaction(accountNumber, txnId, amount, TransactionStatus.FAILED);
		when(accountServiceClient.updateBalance(eq(accountNumber), any(AccountTransactionRequest.class))).thenThrow(new InsufficientBalanceException("Insufficient balance"));
		when(transactionRepository.save(any(Transaction.class))).thenReturn(transaction);
		NotificationRequest notificationRequest = createNotificationRequest(transaction);
		String message = "Notification Logged Successfully";
		when(notificationServiceClient.sendNotification(notificationRequest)).thenReturn(message);
	...
	@Test
	void withdraw_AccountServiceClient_InsufficientBalanceException_DatabaseException() {
		String accountNumber="VIK3710";
		double amount =1000;
		TransactionRequest transactionRequest = createTransactionRequest(accountNumber, amount);
		when(accountServiceClient.updateBalance(eq(accountNumber), any(AccountTransactionRequest.class))).thenThrow(new InsufficientBalanceException("Insufficient balance"));
	...
	@Test
	void withdraw_AccountServiceClient_InsufficientBalanceException_NotificationNotSent() {
		String accountNumber="VIK3710";
		double amount =1000;
		String txnId = GenerateTransactionId.generate();
		TransactionRequest transactionRequest = createTransactionRequest(accountNumber, amount);
	...
	@Test
	void withdraw_AccountServiceClient_BadRequestException() {
		String accountNumber="VIK3710";
		double amount =1000;
		String txnId = GenerateTransactionId.generate();
		TransactionRequest transactionRequest = createTransactionRequest(accountNumber, amount);
		...
		String message = "Notification Logged Successfully";
		when(notificationServiceClient.sendNotification(notificationRequest)).thenReturn(message);
		assertThrows(BadRequestException.class, () -> transactionService.withdraw(transactionRequest));
	    verify(accountServiceClient, times(1)).updateBalance(eq(accountNumber), any(AccountTransactionRequest.class));
	    verify(notificationServiceClient, times(1)).sendNotification(any());
		verify(transactionRepository,times(1)).save(any(Transaction.class));
	}
	@Test
	void withdraw_AccountServiceClient_BadRequestException_DatabaseException() {
		String accountNumber="VIK3710";
		double amount =1000;
		TransactionRequest transactionRequest = createTransactionRequest(accountNumber, amount);
		when(accountServiceClient.updateBalance(eq(accountNumber), any(AccountTransactionRequest.class))).thenThrow(new BadRequestException("Validation Failed"));
	...
	@Test
	void withdraw_AccountServiceClient_BadRequestException_NotificationNotSent() {
		String accountNumber="VIK3710";
		double amount =1000;
		String txnId = GenerateTransactionId.generate();
		TransactionRequest transactionRequest = createTransactionRequest(accountNumber, amount);
	...
	@Test
	void withdraw_AccountServiceClient_ExternalDatabaseException() {
		String accountNumber="VIK3710";
		double amount =1000;
		String txnId = GenerateTransactionId.generate();
		TransactionRequest transactionRequest = createTransactionRequest(accountNumber, amount);
	...
	@Test
	void withdraw_AccountServiceClient_ExternalDatabaseException_DatabaseException() {
		String accountNumber="VIK3710";
		double amount =1000;
		TransactionRequest transactionRequest = createTransactionRequest(accountNumber, amount);
		when(accountServiceClient.updateBalance(eq(accountNumber), any(AccountTransactionRequest.class))).thenThrow(new DatabaseException("Database Error"));
	...
	@Test
	void withdraw_AccountServiceClient_ExternalDatabaseException_NotificationNotSent() {
		String accountNumber="VIK3710";
		double amount =1000;
		String txnId = GenerateTransactionId.generate();
		TransactionRequest transactionRequest = createTransactionRequest(accountNumber, amount);
	...
	@Test
	void withdraw_AccountServiceClient_ExternalServiceException() {
		String accountNumber="VIK3710";
		double amount =1000;
		String txnId = GenerateTransactionId.generate();
		TransactionRequest transactionRequest = createTransactionRequest(accountNumber, amount);
		...
		String message = "Notification Logged Successfully";
		when(notificationServiceClient.sendNotification(notificationRequest)).thenReturn(message);
		assertThrows(ExternalServiceException.class, () -> transactionService.withdraw(transactionRequest));
	    verify(accountServiceClient, times(1)).updateBalance(eq(accountNumber), any(AccountTransactionRequest.class));
	    verify(notificationServiceClient, times(1)).sendNotification(any());
		verify(transactionRepository,times(1)).save(any(Transaction.class));
	}
	@Test
	void withdraw_AccountServiceClient_ExternalServiceException_DatabaseException() {
		String accountNumber="VIK3710";
		double amount =1000;
		TransactionRequest transactionRequest = createTransactionRequest(accountNumber, amount);
		when(accountServiceClient.updateBalance(eq(accountNumber), any(AccountTransactionRequest.class))).thenThrow(new ExternalServiceException("External Service Error"));
	...
	@Test
	void withdraw_AccountServiceClient_ExternalServiceException_NotificationNotSent() {
		String accountNumber="VIK3710";
		double amount =1000;
		String txnId = GenerateTransactionId.generate();
		TransactionRequest transactionRequest = createTransactionRequest(accountNumber, amount);
