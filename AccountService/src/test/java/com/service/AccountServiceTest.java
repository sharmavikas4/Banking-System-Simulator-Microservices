...
public class AccountServiceTest {
	...
	void updateAccountBalance_Deposit_Success() {
		...
		updatedAccountMock.setBalance(1000);
	...
	void updateAccountBalance_Withdraw_Success() {
		String accoutNumber = "VIK3710";
		BalanceUpdateRequest balanceUpdateRequest = new BalanceUpdateRequest(1000, UpdateType.WITHDRAW);
		Account account = new Account();
		account.setAccountNumber("VIK3710");
	...
	void updateAccountBalance_InsufficientBalance() {
		...
		BalanceUpdateRequest balanceUpdateRequest = new BalanceUpdateRequest(1000, UpdateType.WITHDRAW);
		when(accountRepository.findByAccountNumber(accoutNumber)).thenReturn(Optional.of(account));
		assertThrows(InsufficientBalanceException.class, ()->accountService.updateAccountBalance(accoutNumber, balanceUpdateRequest));
		verify(accountRepository,times(1)).findByAccountNumber(accoutNumber);
	}
	
	@Test
	void updateAccountBalance_SavingBalance_DatabaseException() {
		String accoutNumber = "VIK3710";
		Account account = new Account();
		account.setAccountNumber("VIK3710");
		account.setBalance(1000);
	...
	void updateAccountStatus_Success() {
		...
		account.setStatus(Status.ACTIVE);
		account.setHolderName("Vikas Sharma");
		AccountStatusUpdateRequest accountStatusUpdateRequest = new AccountStatusUpdateRequest(Status.INACTIVE);
		when(accountRepository.findByAccountNumber(accoutNumber)).thenReturn(Optional.of(account));
		Account updatedAccount = new Account();
		updatedAccount.setAccountNumber("VIK3710");
		updatedAccount.setBalance(1000);
		updatedAccount.setStatus(Status.INACTIVE);
		updatedAccount.setHolderName("Vikas Sharma");
		when(accountRepository.save(any(Account.class))).thenReturn(updatedAccount);
		Account result = accountService.updateAccountStatus(accoutNumber, accountStatusUpdateRequest);
	...
	void updateAccountStatus_AccountNotFound() {
		String accoutNumber = "VIK3710";
		AccountStatusUpdateRequest accountStatusUpdateRequest = new AccountStatusUpdateRequest(Status.ACTIVE);
		when(accountRepository.findByAccountNumber(accoutNumber)).thenReturn(Optional.empty());
		assertThrows(AccountNotFoundException.class, ()->accountService.updateAccountStatus(accoutNumber, accountStatusUpdateRequest));
		verify(accountRepository,times(1)).findByAccountNumber(accoutNumber);
	}
	
	@Test
	void updateAccountStatus_FindingAccount_DatabaseException() {
		String accoutNumber = "VIK3710";
		AccountStatusUpdateRequest accountStatusUpdateRequest = new AccountStatusUpdateRequest(Status.ACTIVE);
		when(accountRepository.findByAccountNumber(accoutNumber)).thenThrow(new DatabaseException("Database Error"));
		assertThrows(DatabaseException.class, ()->accountService.updateAccountStatus(accoutNumber, accountStatusUpdateRequest));
		verify(accountRepository,times(1)).findByAccountNumber(accoutNumber);
	}
	@Test
	void updateAccountStatus_SameAccountStatus() {
		String accoutNumber = "VIK3710";
		Account account = new Account();
		account.setAccountNumber("VIK3710");
		account.setBalance(1000);
		...
		AccountStatusUpdateRequest accountStatusUpdateRequest = new AccountStatusUpdateRequest(Status.ACTIVE);
		when(accountRepository.findByAccountNumber(accoutNumber)).thenReturn(Optional.of(account));
		assertThrows(SameAccountStatusException.class, ()->accountService.updateAccountStatus(accoutNumber, accountStatusUpdateRequest));
		verify(accountRepository,times(1)).findByAccountNumber(accoutNumber);
	}
	
	@Test
	void updateAccountStatus_SavingUpdatedStatus_DatabaseException() {
		String accoutNumber = "VIK3710";
		Account account = new Account();
		account.setAccountNumber("VIK3710");
		account.setBalance(1000);
